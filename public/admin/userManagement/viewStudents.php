...
<html lang="en">
    <head>
        ...
        <title>UiTM Club Activities Attendance System - Student List</title>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            $(document).ready( function () {
                ...
                var mainTable = $('#appTable').DataTable({
                                    ajax: {
                                        url: '/api/getUserList.php?type=0',
                                        responsive: true,
                                        dataSrc: 'data',
                                    },
                                    fixedHeader: true
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Confirm Delete User</h5>
            ...
            <div class="modal-body">
                ...
                <b class="text-danger">Deleting this user will also delete the associated applications made by the user.</b>
            </div>
