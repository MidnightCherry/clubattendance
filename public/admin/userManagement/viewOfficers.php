...
<html lang="en">
    <head>
        ...
        <title>UiTM Club Activities Attendance System - Officer List</title>
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            $(document).ready( function () {
                ...
                var mainTable = $('#appTable').DataTable({
                                    ajax: {
                                        url: '/api/getUserList.php?type=2',
                                        responsive: true,
                                        dataSrc: 'data',
                                    },
                                    fixedHeader: true
                ...
                $("#appTable tbody").on('click', 'button', function() {
                    ...
                    if(button == "editButton"){
                        window.location.href = "editUser.php?type=2&user_id="+data[0];
                    }
                    if(button == "delButton"){
                        delModal.show();
                    }
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <b class="text-danger">Deleting this user will also nullify the associated applications approved by the user.</b>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-danger" onclick="window.location.href = 'doDeleteUser.php?role=2user_id='+dataFirstColumn;">Proceed</button>
            </div>
            </div>
        </div>
        </div>
