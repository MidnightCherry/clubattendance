...
<html lang="en">
    <head>
        ...
        <title>UiTM Club Activities Attendance System - Admin List</title>
    ...
    <body>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" onclick="window.location.href = 'doDeleteUser.php?role=1user_id='+dataFirstColumn;">Proceed</button>
            </div>
            </div>
        </div>
        </div>
