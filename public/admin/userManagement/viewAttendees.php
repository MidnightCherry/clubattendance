...
<html lang="en">
    <head>
        ...
        <title>UiTM Club Activities Attendance System - Attendee List</title>
    ...
    <body>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <b class="text-danger">Deleting this user will also delete the associated attendances made by the user.</b>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-danger" onclick="window.location.href = 'doDeleteUser.php?role=3user_id='+dataFirstColumn;">Proceed</button>
            </div>
            </div>
        </div>
        </div>
